...
export default function PortfolioCaseStudy() {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#0a0a0f] text-white text-start">
      ...
      {/* 3. Category-Specific Block */}
      <section className="px-4 md:px-8 py-20 max-w-7xl mx-auto">
        {project.categorySlug === "web" && project.liveUrl && (
          <motion.div 
        ...
        {(project.categorySlug === "cgi" || project.categorySlug === "production") && project.videoUrl && (
          <motion.div 
             initial={{ opacity: 0, y: 20 }}
             whileInView={{ opacity: 1, y: 0 }}
             viewport={{ once: true }}
        ...
        {project.categorySlug === "social" && project.platforms && (
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
