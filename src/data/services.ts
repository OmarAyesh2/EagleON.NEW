...
export const services: Service[] = [
    ...
    process: [
      {
        ...
        description: { ar: "نفهم أهداف مشروعك ونحدد النطاق التقني", en: "We understand your project goals and define the technical scope" }
      },
      {
        title: { ar: "التصميم والنموذج الأولي", en: "Design & Prototype" },
        description: { ar: "نصمم واجهات المستخدم ونبني نموذج تفاعلي للموافقة", en: "We design the UI and build an interactive prototype for approval" }
      },
      {
        title: { ar: "التطوير والاختبار", en: "Development & Testing" },
        description: { ar: "نكتب الكود ونختبر كل وظيفة بدقة", en: "We write the code and rigorously test every feature" }
      },
      {
        title: { ar: "الإطلاق والمتابعة", en: "Launch & Monitor" },
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description: { ar: "حركات سلسة وتأثيرات ديناميكية تضيف حياة لمشاريعك", en: "Smooth motion and dynamic effects that bring your projects to life" }
      },
      {
        title: { ar: "تأثيرات بصرية VFX", en: "Visual Effects (VFX)" },
        description: { ar: "مؤثرات سينمائية متقدمة للإعلانات والفيديوهات", en: "Advanced cinematic effects for ads and videos" }
      },
      {
        title: { ar: "محاكاة منتجات واقعية", en: "Product Visualization" },
        description: { ar: "عرض منتجاتك بشكل ثلاثي الأبعاد واقعي قبل التصنيع", en: "Showcase your products in realistic 3D before manufacturing" }
      },
      {
        title: { ar: "إنتاج فيديو إعلاني", en: "Commercial Video Production" },
        description: { ar: "فيديوهات إعلانية كاملة من المفهوم إلى التسليم النهائي", en: "Complete ad videos from concept to final delivery" }
      }
    ],
    process: [
      {
        title: { ar: "المفهوم والقصة", en: "Concept & Storyboard" },
        description: { ar: "نطور الفكرة الإبداعية ونرسم مخطط القصة", en: "We develop the creative concept and storyboard" }
      },
      {
        title: { ar: "النمذجة والتكوين", en: "Modeling & Texturing" },
        description: { ar: "نبني النماذج ثلاثية الأبعاد ونضيف المواد والإضاءة", en: "We build 3D models and add materials and lighting" }
      },
      {
        title: { ar: "التحريك والتصيير", en: "Animation & Rendering" },
        description: { ar: "نحرك المشهد ونصيره بأعلى جودة", en: "We animate the scene and render at the highest quality" }
      },
      {
  ...
  },
  {
    ...
    features: [
      {
        title: { ar: "استراتيجية العلامة التجارية", en: "Brand Strategy" },
        description: { ar: "تحليل السوق والمنافسين وتحديد موقعك الفريد", en: "Market and competitor analysis to define your unique positioning" }
      },
      {
        title: { ar: "تصميم الشعار", en: "Logo Design" },
        description: { ar: "شعار فريد يعكس شخصية علامتك ويتميز بالبساطة والقوة", en: "A unique logo that reflects your brand personality with simplicity and power" }
      },
      {
        title: { ar: "نظام الألوان والخطوط", en: "Color & Typography System" },
        description: { ar: "لوحة ألوان وخطوط متناسقة تعزز هوية علامتك", en: "A cohesive color palette and typography system that reinforces your identity" }
      },
      {
        title: { ar: "دليل الهوية البصرية", en: "Brand Guidelines Manual" },
        description: { ar: "دليل شامل يضمن تطبيق هويتك بشكل متسق في كل مكان", en: "A comprehensive guide ensuring consistent application of your identity everywhere" }
      },
      {
        title: { ar: "تطبيقات الهوية", en: "Brand Applications" },
        description: { ar: "تصاميم بطاقات العمل والأوراق الرسمية والمطبوعات", en: "Business cards, stationery, and print material designs" }
      }
    ],
    process: [
      {
        title: { ar: "البحث والاكتشاف", en: "Research & Discovery" },
        description: { ar: "نفهم قيمك وجمهورك ورؤيتك", en: "We understand your values, audience, and vision" }
      },
      {
        title: { ar: "التطوير الإبداعي", en: "Creative Development" },
        description: { ar: "نطور مفاهيم بصرية متعددة للاختيار", en: "We develop multiple visual concepts for selection" }
      },
      {
        title: { ar: "التنقيح والإتقان", en: "Refinement & Perfection" },
        description: { ar: "نصقل التصميم المختار حتى يصل للكمال", en: "We refine the chosen design until it reaches perfection" }
      },
      {
        title: { ar: "التسليم والإرشاد", en: "Delivery & Guidance" },
  ...
  },
  {
    ...
    features: [
      {
        title: { ar: "استراتيجية المحتوى", en: "Content Strategy" },
        description: { ar: "خطة محتوى شهرية مدروسة تتماشى مع أهدافك التسويقية", en: "A calculated monthly content plan aligned with your marketing goals" }
      },
      {
        title: { ar: "تصميم المنشورات", en: "Post Design & Creation" },
        description: { ar: "تصاميم احترافية وكتابة محتوى يجذب التفاعل", en: "Professional designs and copywriting that drive engagement" }
      },
      {
        title: { ar: "إدارة الإعلانات المدفوعة", en: "Paid Ads Management" },
        description: { ar: "حملات إعلانية مستهدفة لزيادة الوصول والتحويلات", en: "Targeted ad campaigns to increase reach and conversions" }
      },
      {
        title: { ar: "التقارير والتحليلات", en: "Reports & Analytics" },
        description: { ar: "تقارير أداء شهرية مفصلة مع توصيات للتحسين", en: "Detailed monthly performance reports with improvement recommendations" }
      }
    ],
    process: [
      {
        title: { ar: "تحليل الحسابات", en: "Account Audit" },
        description: { ar: "نحلل وضعك الحالي ونحدد فرص النمو", en: "We analyze your current state and identify growth opportunities" }
      },
      {
        title: { ar: "بناء الاستراتيجية", en: "Strategy Building" },
        description: { ar: "نضع خطة محتوى وتقويم نشر مخصص", en: "We create a content plan and custom publishing calendar" }
      },
      {
        title: { ar: "التنفيذ والنشر", en: "Execution & Publishing" },
        description: { ar: "ننتج المحتوى وننشره في الأوقات المثالية", en: "We produce content and publish at optimal times" }
      },
      {
        title: { ar: "القياس والتحسين", en: "Measure & Optimize" },
  ...
  },
  {
    ...
    features: [
      {
        title: { ar: "كتابة السيناريو", en: "Scriptwriting" },
        description: { ar: "نكتب قصصاً مؤثرة تنقل رسالة علامتك بوضوح", en: "We write compelling stories that convey your brand message clearly" }
      },
      {
        title: { ar: "التصوير السينمائي", en: "Cinematography" },
        description: { ar: "تصوير احترافي بمعدات متقدمة وفريق متخصص", en: "Professional filming with advanced equipment and a specialized crew" }
      },
      {
        title: { ar: "المونتاج وتصحيح الألوان", en: "Editing & Color Grading" },
        description: { ar: "مونتاج سلس وتصحيح ألوان سينمائي يرفع جودة المحتوى", en: "Smooth editing and cinematic color grading that elevates content quality" }
      },
      {
        title: { ar: "التصوير الفوتوغرافي", en: "Photography" },
        description: { ar: "صور منتجات وبورتريهات احترافية لعلامتك التجارية", en: "Product photography and professional portraits for your brand" }
      }
    ],
    process: [
      {
      ...
      {
        title: { ar: "التصوير", en: "Production" },
