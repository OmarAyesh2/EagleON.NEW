...
function Navbar() {
    ...
    // A naive approach for language toggle. We track it in state and manipulate html tag.
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Navbar.useEffect": ()=>{
            // Initial check for HTML tag attributes on mount
            const html = document.documentElement;
            if (html.lang === "en") setLang("en");
        }
    }["Navbar.useEffect"], []);
...
_s(Navbar, "hTZ1sbxG1im9vajDGzGeEgDmAQA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"]
    ];
});
...
//# sourceMappingURL=src_5ec8cddf._.js.map